...
$ArrData["special_product_name"] = $result_product_id[0]['special_product_name'];
...

	{
		...
		if (check_oauth_key($oauth_key)) {
			...
			$result_val = $this->products_model->get_product_by_category_slug($json_obj->category_slug);
...

	{
		...
		if (check_oauth_key($oauth_key)) {
			...
			$result_val = $this->products_model->get_related_product_by_category_slug($json_obj->category_slug,$json_obj->product_id);
