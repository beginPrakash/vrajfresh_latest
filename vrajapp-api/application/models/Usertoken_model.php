...
{
    public function add_usetoken($data)
    {
        $this->db->insert('tbl_users_token', $data);
    ...
    public function verify_usertoken($data, $user_id,$usertoken)
    {
       $query = $this->db->where('user_id', $user_id)
            ->where('user_token', $usertoken)->get('tbl_users_token');
