		...
		<div class="container-flex ">
			<div class="category-filter">
				...
				<div>
					...
					<div class="accordion">
						<input placeholder="Min price" id="min_price" name="" type="text">
						<span>To</span>
						<input placeholder="Max price" id="max_price" name="" type="text">
					</div>
				</div>
				<div id="tags">
