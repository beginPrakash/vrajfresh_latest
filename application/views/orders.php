        ...
        $.ajax({
            ...
            "success": function (response) {
                ...
                if (response.data != null) {
                    ...
                    var table = '<tr><th scope="col">ORDER</th><th scope="col">DATE</th><th scope="col">STATUS</th><th scope="col">	TOTAL</th><th scope="col">ACTIONS</th></tr>';

                    for (let a = 0; a < response.data.length; a++) {

                        table += '<tr><td><a href="#">' + response.data[a].order_id + '</a></td><td>' + response.data[a].order_datetime + '</td><td>' + response.data[a].order_status + '</td><td>' + response.data[a].order_total_amount + '</td><td><a href="<?php echo BASE_URL . 'Controller_users/orders_detail/'; ?>' + response.data[a].order_id + '" class="openpop" id="myBtn">View</a></td></tr>';
