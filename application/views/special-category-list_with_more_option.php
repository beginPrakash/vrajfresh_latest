					...
					if (response.data.product_detail != "") {
						...
						for (let a = 0; a < response.data.product_detail.length; a++) {
							...
							else
							{
								...
								{ 
									price_weight = ''
									var buttonSection = '<a href="<?php echo BASE_URL; ?>product/' + response.data.product_detail[a].product_slug +'"><ul><li><button class="add_cart">More Options</button></li></ul></a>';
								}
								else
								{
							...
							product = product.concat('<div class="product-box"><a href="<?php echo BASE_URL; ?>product/' + response.data.product_detail[a].product_slug +
								'"> <div class="begin_img_container"><img src=' + response.data.product_detail[a].image + ' onerror=this.src="<?php echo BASE_URL; ?>assets/images/logo-2.png"></div><h4>' + response.data.product_detail[a].product_name +
