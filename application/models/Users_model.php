...
class Users_model extends CI_Model
{
    ...
    {
        $query = $this->db->select('u.user_name,u.user_id,u.email,u.zipcode,u.mobile_no,u.created_by,ur.user_role_name,u.is_active,u.card_num,u.card_exp_month,u.card_exp_year,u.card_cvc')
            ->join('tbl_user_roles ur', 'u.user_role_id=ur.user_role_id')
