...
defined('BASE_URL')         OR define('BASE_URL','http://3.97.75.200/api/');
defined('ASSET_URL')         OR define('ASSET_URL',BASE_URL.'assets/');
defined('FRONT_URL')         OR define('FRONT_URL','http://3.97.75.200/');

defined('ADMIN_URL')         OR define('ADMIN_URL','http://3.97.75.200/admin/');
