            ...
            case 'css':
                ...
                foreach ($files as $file) {
                    ...
                    if (($ext == $flag) && $fl >= 42 && (filemtime($this->cache_path . $file) < $before)) {
                        ...
                        if ($success):
                            log_message('debug', 'Carabiner: Cache file ' . $file . ' was removed from ' . $this->cache_path);
                        else:
                            log_message('error', 'Carabiner: There was an error removing cache file ' . $file . ' from ' . $this->cache_path);
                        endif;
                    }
                }
