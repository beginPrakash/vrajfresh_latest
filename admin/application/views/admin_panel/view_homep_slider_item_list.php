      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>homep_slider_item" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_product_slider_item/delete_multiple_brand_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_product_slider_item/view_slider_item_ajax"
...
<script type="text/javascript">
   ...
   var cols = [{ "bSortable": false }, { "bSortable": true }, { "bSortable": true }, { "bSortable": false }, { "bSortable": true }];
