            ...
            <div class="box-info">
               ...
               <div class="box-text box-body">
                  ...
                  if (isset($edit_id) && $edit_id > 0) {
                     ...
                     $attributes = array('class' => 'form-horizontal', 'id' => 'new_savings__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('new_savings-update/' . $edit_id, $attributes);

                  } else {

                     $attributes = array('class' => 'form-horizontal', 'id' => 'new_savings__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('new_savings-add', $attributes);
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           ...
                           <select name="savings_product_id" id="savings_product_id" class="selectpicker form-control"
                              ...
                              $product_id = !empty($edit_id) ? $brand['savings_product_id'] : '';
                           ...
                           <?php echo form_error('savings_product_id'); ?>

                           <p id="savings_product_iderror"></p>
