<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_customer/customer_list_export"
         ...
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/controller_customer/delete_multiple_customer_record"
            id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_customer/view_customer_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
