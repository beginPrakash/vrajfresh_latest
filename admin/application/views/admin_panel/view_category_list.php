<div class="row">
   <div class="col-xs-12">
      <div class="box">
         ...
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/Controller_category/delete_multiple_category_record"
            id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_category/view_category_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
