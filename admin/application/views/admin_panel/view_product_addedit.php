...
$(document).ready(function() {
  $('input[type="file"]').change(function() {
    ...
    if ($.inArray(extension, allowedExtensions) === -1) {
      alert('Invalid file extension. Please upload a GIF, JPG, JPEG, or PNG file.');
      $(this).val('');
    }
  });
});
                  ...
                  <div class="box-body">
                     ...
                     <div class="box_bg_color">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <div>
                                 <label>Unit Cost : <span class="red">*</span></label>
                                 <input type="text" placeholder="Unit Cost" class="form-control only_number" name="unit_cost" id="unit_cost" value="<?php echo (!empty($edit_id)) ? $product['unit_cost'] : ''; ?>" required>
                                 <?php echo form_error('unit_cost'); ?>
                              </div>
                           </div>
                           <div class="col-sm-3">
                              <div>
                        ...
                        <div class="form-group">
                           <div class="col-sm-12">
                              <div>
                                 ...
                                 <input type="text" class="form-control" name="search_tags" id="search_tags" value="<?php echo (!empty($edit_id)) ? $product['search_tags'] : ''; ?>" data-role="tagsinput" />
                              </div>
                           </div>
                        </div>
                ...
                <div class="col-sm-12">
                     ...
                     foreach ($ArrPVValue as $variant_value) {
                        ...
                        <div class="form-group">
                           <div class="col-sm-3">
                              <div class="radio_btn_design_add_products">
                                 <label style="padding-left: 0px; width: 100%;">Display Perishable : </label>
                                 <div class="checkbox">
                                    <?php if (!empty($edit_id)) { ?>
                                       <label style="padding-left: 0px; width: 100%;">
                                          <input type="radio" name="is_perisible_products" value="1" <?php if ($product['is_perisible_products'] == "1") {
                                             echo "checked";
                                          } ?>> Yes
                                          <input type="radio" name="is_perisible_products" value="0" <?php if ($product['is_perisible_products'] == "0") {
                                             echo "checked";
                                          } ?>> No
                                       </label>
                                    <?php } else { ?>
                                       <label style="padding-left: 0px;"><input type="radio" name="is_perisible_products" value="1"> Yes </label>
                                       <label><input type="radio" name="is_perisible_products" value="0" checked> No </label>
                                    <?php } ?>
                                 </div>
                                 <?php echo form_error('is_featured'); ?>
                              </div>
                           ...
                           <div class="col-sm-3">
                              <div class="radio_btn_design_add_products">
                                 <label style="padding-left: 0px; width: 100%;">Display Liquor : </label>
                                 <div class="checkbox">
                                    <?php if (!empty($edit_id)) { ?>
                                       <label style="padding-left: 0px; width: 100%;">
                                          <input type="radio" name="is_liker_products" value="1" <?php if ($product['is_liker_products'] == "1") {
                                             echo "checked";
                                          } ?>> Yes
                                          <input type="radio" name="is_liker_products" value="0" <?php if ($product['is_liker_products'] == "0") {
                                             echo "checked";
                                          } ?>> No
                                       </label>
                                    <?php } else { ?>
                                       <label style="padding-left: 0px;"><input type="radio" name="is_liker_products" value="1"> Yes </label>
                                       <label><input type="radio" name="is_liker_products" value="0" checked> No </label>
                                    <?php } ?>
                                 </div>
                                 <?php echo form_error('is_featured'); ?>
                              </div>
                           ...
                           <div class="col-sm-3">
                              <div class="radio_btn_design_add_products">
                                 <label style="padding-left: 0px; width: 100%;">Display Cook Food : </label>
                                 <div class="checkbox">
                                    <?php if (!empty($edit_id)) { ?>
                                       <label style="padding-left: 0px; width: 100%;">
                                          <input type="radio" name="is_cook_food_products" value="1" <?php if ($product['is_cook_food_products'] == "1") {
                                             echo "checked";
                                          } ?>> Yes
                                          <input type="radio" name="is_cook_food_products" value="0" <?php if ($product['is_cook_food_products'] == "0") {
                                             echo "checked";
                                          } ?>> No
                                       </label>
                                    <?php } else { ?>
                                       <label style="padding-left: 0px;"><input type="radio" name="is_cook_food_products" value="1"> Yes </label>
                                       <label><input type="radio" name="is_cook_food_products" value="0" checked> No </label>
                                    <?php } ?>
                                 </div>
                                 <?php echo form_error('is_featured'); ?>
                              </div>
