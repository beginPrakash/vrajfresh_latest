					...
					<div class="box-text box-body">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="user_signup_date" id="user_signup_date"
										...
										class="form-control mdycalender" />
									-
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="amount_outstanding" id="amount_outstanding"
										placeholder="Amount e.g. 5000" class="custom_txtbox only_number"
										style="width:150px;" />
									-
									<input type="text" name="amount_outstanding_to" id="amount_outstanding_to"
										placeholder="Amount e.g. 5000" class="custom_txtbox only_number"
										style="width:150px;" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="last_order_date" style="width:150px;" id="last_order_date"
										value="" placeholder="Last Order Date" class="form-control mdycalender" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9"><select name="selProduct" id="selProduct" class="form-control">
										...
										<?php foreach ($ArrProducts as $product) { ?>
											<option value="<?php echo $product['product_id']; ?>" <?php if ($product['product_id'] == $clientgroup[0]['product_id']) {
												   echo 'selected';
