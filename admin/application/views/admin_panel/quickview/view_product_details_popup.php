<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['product_sku'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['product_name'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['product_sub_name'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['product_weight_gms'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['product_price'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['sale_price'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      ...
      <img src="<?php echo $imag; ?>" alt="No Image Found" width="150">
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo ($ArrFieldData['is_out_of_stock'] == '1') ? 'No' : 'Yes'; ?>
      </label>
   </div>
</div>
<div class="row">
