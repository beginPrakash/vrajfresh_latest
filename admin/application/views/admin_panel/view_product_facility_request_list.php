<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <div class="row">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden"
                     value="<?php echo SITE_URL ?>adminpanel/controller_product_facility_request/product_facility_request_list_export"
         ...
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/controller_product_facility_request/delete_multiple_product_facility_request_record"
            id="multiple_delete_action">
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/controller_product_facility_request/view_product_facility_request_ajax"
            id="view_action">
      </div>
   </div>
</div>
