					...
					<div class="intersted-in-container-main">
						...
						<table id="listdata" class="table table-bordered table-striped">
							...
							<tbody>
								...
								if (is_array($ArrGroupClient) && count($ArrGroupClient) > 0) {
									foreach ($ArrGroupClient as $client) {
										...
										<tr>
											<td>
												<?php echo $client['format_joining_date']; ?>
											</td>
											<td>
											...
											<td>
												<input type="checkbox" class="chkDelete" name="delete[]"
													value="<?php echo $client['clientgroup_details_id']; ?>" />
											</td>
										</tr>
									<?php
									}
							...
							<tfoot>
								<tr>
									<td colspan="3"></td>
									<td><input type="submit" name="submitForm" value="Delete"
											class="btn btn-danger pull-left" onClick="return checkCheckedOrNot();" />
									</td>
								</tr>
							</tfoot>
