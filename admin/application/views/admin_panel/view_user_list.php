<div class="row">
	<div class="col-xs-12">
		<div class="box">
					...
					<form id="frmListDataFilter" action="<?php echo SITE_URL ?>user" method="post">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control date_picker_bottom_center" name="txtSearchFrom"
								id="txtSearchFrom" placeholder="Created From" title="Created From" autocomplete="false">
						</div>
						<div class="col-sm-2">
							<input type="text" class="form-control date_picker_bottom_center" name="txtSearchTo"
								id="txtSearchTo" placeholder="Created To" title="Created To" autocomplete="false">
						</div>
						<div class="col-sm-2">
							<?php
			...
			<input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_user/delete_multiple_user_record"
				id="multiple_delete_action">
			<input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_user/view_portfolio_ajax"
				id="view_action">
			<!-- /.box-body -->
		</div>
		<!-- /.box -->
