      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>stockup" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_stockup/delete_multiple_brand_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_stockup/view_stockup_ajax"
