			...
			<form role="form" method="post" action="<?php echo SITE_URL ?>adminpanel/controller_product_variant/save">
				<div class="box-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="product_variant_name" name="product_variant_name"
							placeholder="Enter product_variant_name" onKeyUp="convertToSlug();"
							value="<?php echo (isset($ArrProductVariantData['product_variant_name'])) ? trim($ArrProductVariantData['product_variant_name']) : ''; ?>">
						<div class="alert alert-danger" role="alert" style="display:none"></div>
						<input type="hidden" name="product_variant_id" id="product_variant_id"
							value="<?php echo (isset($ArrProductVariantData['product_variant_id'])) ? trim($ArrProductVariantData['product_variant_id']) : ''; ?>">
					</div>
							...
							<div class="col-md-9">
								...
								<table id="promotional_code_product_variants">
									...
									if (is_array($ArrSelectedProducts) && count($ArrSelectedProducts) > 0) {
										foreach ($ArrSelectedProducts as $value) {
											...
											<tr>
												...
												<td><input type="text" name="product_variant_value[]" required
														value="<?php echo $value; ?>" placeholder="Value"
														class="form-control only_number discountValue<?php echo $product_variant_counter; ?>">
									...
									<tr>
										...
										<td><input type="text" name="product_variant_value[]" placeholder="Value"
												class="form-control only_number discountValue1">
											<?php echo form_error('product_variant_value'); ?>
										</td>
										<td><a href="javascript:void(0);" onClick="addRow()"
												title="Click here to add new value"><img
								...
								<input type="hidden" name="product_variant_counter" id="product_variant_counter"
									value="<?php echo $product_variant_counter; ?>" />
							</div>
						</div>
					</div>
				...
				<div class="box-footer">
					<input type="submit" name="save_product_variant" class="btn btn-default"
						value="<?php echo (isset($ArrProductVariantData['product_variant_id']) && $ArrProductVariantData['product_variant_id'] > 0) ? 'Update' : 'Add'; ?>">
