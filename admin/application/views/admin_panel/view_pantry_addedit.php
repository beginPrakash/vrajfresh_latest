            ...
            <div class="box-info">
               ...
               <div class="box-text box-body">
                  ...
                  if (isset($edit_id) && $edit_id > 0) {
                     ...
                     $attributes = array('class' => 'form-horizontal', 'id' => 'pantry__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('pantry-update/' . $edit_id, $attributes);

                  } else {

                     $attributes = array('class' => 'form-horizontal', 'id' => 'pantry__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('pantry-add', $attributes);
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           ...
                           <label>Pantry Name <span class="red">*</span>: </label>

                        </div>

                        <div class="col-md-9">

                           <input type="text" placeholder="Name" class="form-control" name="pantry_name" value="<?php

                           echo (isset($edit_id) && $edit_id > 0) ? $brand['pantry_name'] : ''; ?>" required>

                           <?php echo form_error('pantry_name'); ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           ...
                           <label>Pantry URL: </label>

                        </div>

                        <div class="col-md-9">

                           <input type="text" placeholder="URL" class="form-control" name="pantry_link" value="<?php

                           echo (isset($edit_id) && $edit_id > 0) ? $brand['pantry_link'] : ''; ?>" required>

                           <?php echo form_error('pantry_link'); ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6">
                        ...
                        <?php if (isset($brand) && $brand['pantry_image'] != '') { ?>
                           ...
                           <div class="col-md-3">
                              ...
                              <img height="25px" width="25px"
                                 ...
                                 src='<?php echo base_url(); ?>uploads/pantry/<?php echo $brand['pantry_image'] ?>' border=0>

                           </div>

                           <div class="col-md-6">

                              <input type="file" class="form-control" name="pantry_image">

                           </div>

                           <input type="hidden" value="<?php echo $brand['pantry_image'] ?>" name="cat_image">
                        ...
                        <?php echo form_error('pantry_image'); ?>
