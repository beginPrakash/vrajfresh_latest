            ...
            <div class="box-info">
               ...
               <div class="box-text box-body">
                  ...
                  if (isset($edit_id) && $edit_id > 0) {
                     ...
                     $attributes = array('class' => 'form-horizontal', 'id' => 'vraj_bakery__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('vraj_bakery-update/' . $edit_id, $attributes);

                  } else {

                     $attributes = array('class' => 'form-horizontal', 'id' => 'vraj_bakery__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('vraj_bakery-add', $attributes);
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           ...
                           <select name="bakery_product_id" id="bakery_product_id" class="selectpicker form-control"
                              ...
                              $product_id = !empty($edit_id) ? $brand['bakery_product_id'] : '';
                           ...
                           <?php echo form_error('bakery_product_id'); ?>

                           <p id="bakery_product_iderror"></p>
