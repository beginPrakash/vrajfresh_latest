      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>advertises" method="post">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_banner/banner_list_export"
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_adver_top/delete_multiple_banner_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_adver_top/view_banner_ajax"
