      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>appbannercategory_product" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_catpro/delete_multiple_banner_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_banner/view_banner_ajax"
...
<script type="text/javascript">
   ...
   var cols = [{ "bSortable": false }, { "bSortable": false },{ "bSortable": true }, { "bSortable": true }, { "bSortable": true }, { "bSortable": true }];
