      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>homebanners" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_home_banner/delete_multiple_banner_record"
