            ...
            <div class="box-info">
               ...
               <div class="box-text box-body">
                  ...
                  if (isset($edit_id) && $edit_id > 0) {
                     ...
                     $attributes = array('class' => 'form-horizontal', 'id' => 'fresh_veg__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('fresh_veg-update/' . $edit_id, $attributes);

                  } else {

                     $attributes = array('class' => 'form-horizontal', 'id' => 'fresh_veg__form', 'role' => 'form', 'enctype' => 'multipart/form-data');

                     echo form_open('fresh_veg-add', $attributes);
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           ...
                           <select name="fresh_product_id" id="fresh_product_id" class="selectpicker form-control"
                              ...
                              $product_id = !empty($edit_id) ? $brand['fresh_product_id'] : '';
                           ...
                           <?php echo form_error('fresh_product_id'); ?>

                           <p id="fresh_product_iderror"></p>
