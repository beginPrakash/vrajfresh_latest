...
<style>
   ...
   .break-after-characters {
      ...
      max-width: 53px;        /* Set maximum width to trigger wrapping */
   }
</style>
<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>brand_reports" method="post">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-4">
                     <select name="src_brand[]" id="src_brand" class="multiple_brand_select" multiple="">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/Controller_brandreport/order_list_export"
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_brandreport/view_customer_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
