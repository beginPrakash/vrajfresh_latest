   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>order_reports" method="post">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-2">
                     <select class="form-control" style="width: 100%;" name="paymentStatus" id="paymentStatus">
                  ...
                  <div class="col-sm-2">
                     <input size="15" type="text" class="extra_field form-control" name="txtSearchZipcode"
                        id="txtSearchZipcode" placeholder="Search Zipcode" />
                  </div>
                  <div class="col-sm-2">
               ...
               <div class="col-md-12">
                  <input type="submit" class="btn btn-warning" name="searchExport" id="searchExport" value="Export to CSV" style="float:left;">
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_orderreport/order_list_export"
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_orderreport/view_customer_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
...
<script type="text/javascript">
   ...
   var ajaxURL1 = {
      ...
      data: function (d) {
         ...
         d.txtSearchZipcode = $("#txtSearchZipcode").val();
