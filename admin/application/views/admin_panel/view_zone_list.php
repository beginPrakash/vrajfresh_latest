   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>zone" method="post">
                  <div class="col-sm-2">
         ...
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/Controller_zone/delete_multiple_product_record"
            id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_zone/view_product_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
...
<script type="text/javascript">
   /* DATA TABLE JS */
   var orderCol = [[2, "desc"]];
   var cols = [{ "bSortable": false }, { "bSortable": true }, { "bSortable": true }];
   var colDef = [0, 4];
