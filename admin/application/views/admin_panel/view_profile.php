						...
						<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" placeholder="Login Name" class="form-control"
											name="user_name" value="<?php echo $user['user_name']; ?>" required />
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" placeholder="Address Line 1" class="form-control"
											name="address1" value="<?php echo $user['address']; ?>">
										<?php //echo form_error('name'); ?>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" placeholder="Address Line 2" class="form-control"
											name="address2" value="<?php echo $user['address2']; ?>">
										<?php //echo form_error('name'); ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" placeholder="ZIP Code" class="form-control only_number"
											name="zip" value="<?php echo $user['zip']; ?>">
										<?php //echo form_error('name'); ?>
									</div>
								</div>
