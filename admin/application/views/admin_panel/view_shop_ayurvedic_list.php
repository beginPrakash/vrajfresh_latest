      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>shop_ayurvedic" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_shop_ayurvedic/delete_multiple_brand_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_shop_ayurvedic/view_shop_ajax"
...
<script type="text/javascript">
   ...
   var cols = [{ "bSortable": false }, { "bSortable": true }, { "bSortable": false }, { "bSortable": true }];
