   ...
   <div class="col-md-12">
      ...
      <div class="box box-primary">
            ...
            <div class="add_users_page_form_main">
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['display_name'] ?>" placeholder="Display Name"
                        class="form-control" name="display_name" required>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['mobile_no'] ?>" placeholder="Mobile"
                        class="form-control numberonly" name="mobile_no" required maxlength="12">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Address 1 : </label>
                     <input type="text" value="<?php echo @$ArrFieldData['shipping_street_address'] ?>"
                        placeholder="Address 1" class="form-control" name="shipping_street_address">
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Address 2 : </label>
                     <input type="text" value="<?php echo @$ArrFieldData['shipping_apartment'] ?>"
                        placeholder="Address 2" class="form-control" name="shipping_apartment">
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>City : </label>
                     <input type="text" value="<?php echo @$ArrFieldData['shipping_city'] ?>" placeholder="City"
                        class="form-control" name="shipping_city">
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <?php $shipping_state = (isset($ArrFieldData['shipping_state'])) ? $ArrFieldData['shipping_state'] : 0; ?>
                     <div id="stateSDD">
                        <?php echo form_dropdown('shipping_state', $ArrStateOption, $shipping_state, 'id="shipping_state" class="form-control"'); ?>
                     </div>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['shipping_zip_code'] ?>" placeholder="ZIP Code"
                        class="form-control numberonly" name="shipping_zip_code" maxlength="12">
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Phone : </label>
                     <input type="text" value="<?php echo @$ArrFieldData['shipping_phone'] ?>" placeholder="Phone"
                        class="form-control" name="shipping_phone" maxlength="12">
                  </div>
               </div>
         ...
         <div class="box-footer">
            ...
            <input type="hidden" id="user_exist" name="user_role_id"
               value="<?php echo (isset($ArrFieldData['user_role_id']) && $ArrFieldData['user_role_id'] > 0) ? $ArrFieldData['user_role_id'] : 0; ?>">
         </div>
         <!-- /.box-footer -->
         </form>
      </div>
