                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           ...
                           <textarea placeholder="Long Description" rows="3" id="editor1" class="form-control"
                              name="brand_description"><?php echo (isset($edit_id) && $edit_id > 0) ? $brand['brand_description'] : ''; ?></textarea>
                        ...
                        <?php if (isset($brand) && $brand['brand_image'] != '') { ?>
                           ...
                           <div class="col-md-3">
                              <img height="25px" width="25px"
                                 src='<?php echo base_url(); ?>uploads/brand/<?php echo $brand['brand_image'] ?>' border=0>
                           </div>
                           <div class="col-md-6">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <input type="text" placeholder="Meta Title" class="form-control" name="meta_title"
                           value="<?php echo (isset($edit_id) && $edit_id > 0) ? $brand['meta_title'] : ''; ?>">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <input type="text" placeholder="Meta Keyword" class="form-control" name="meta_keyword"
                           value="<?php echo (isset($edit_id) && $edit_id > 0) ? $brand['meta_keyword'] : ''; ?>">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <textarea placeholder="Meta Description" rows="3" class="form-control"
                           name="meta_description"><?php echo (isset($edit_id) && $edit_id > 0) ? $brand['meta_description'] : ''; ?></textarea>
