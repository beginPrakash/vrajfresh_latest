      ...
      <div class="box">
         ...
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>homep_slider" method="post">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_home_product_slider/delete_multiple_banner_record"

            id="multiple_delete_action">

         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_home_product_slider/view_homep_slider_ajax"
