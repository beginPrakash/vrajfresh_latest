<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_tag/tag_list_export"
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_tag/delete_multiple_tag_record"
