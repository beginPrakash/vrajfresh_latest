      ...
      <div class="box">
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                  <input type="submit" class="btn btn-warning" name="searchExport" id="searchExport"
                     value="Export to CSV">
                  <input type="hidden"
                     value="<?php echo SITE_URL ?>adminpanel/controller_newsletter_subscriber/newsletter_subscriber_list_export"
         ...
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/controller_newsletter_subscriber/delete_multiple_newsletter_subscriber_record"
            id="multiple_delete_action">
         <input type="hidden"
            value="<?php echo base_url() ?>adminpanel/controller_newsletter_subscriber/view_newsletter_subscriber_ajax"
            id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
