	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header filter_div">
				<form class="filter_form" id="frmListDataFilter" action="<?php echo SITE_URL ?>menu" method="post">
					<div class="row">
						<div class="col-sm-2">
						...
						<div class="col-sm-2">
							...
							<input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_menu/menu_list_export" id="searchExportaction">
						</div>
						<!-- add export btn - END //- -->
					</div>
				</form>
...
<script type="text/javascript">
	...
	function menu_detail(menu_id) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url() ?>adminpanel/controller_menu/ajaxShowTblmenuMasterData",
			data: "menu_id=" + menu_id,
			success: function (results) {
				$(document.body).css({ 'cursor': 'default' });
				$('#recordDetailsPopUp').modal('show');
				$('#detailsPopUpData').html(results);
				$('#detailsPopUpTitle').html('Menu Names Details');
			},
			error: function () {
				$(document.body).css({ 'cursor': 'default' });
	...
	//- export csv file of menu list - START
...
//- export csv file of menu list - END
