	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header filter_div">
				<form class="filter_form" id="frmListDataFilter" action="<?php echo SITE_URL ?>product_variant" method="post">
					<div class="row">
						<div class="col-sm-2">
						...
						<div class="col-sm-2">
							...
							<input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_product_variant/product_variant_list_export" id="searchExportaction">
						</div>
						<!-- add export btn - END //- -->
					</div>
				</form>
...
/* DATA TABLE JS */
var orderCol = [[ 1, "desc" ]];  
var cols = [{ "bSortable": false },{ "bSortable": true },{ "bSortable": true },{ "bSortable": true }, { "bSortable": false },];
var colDef = [0,4];
var aoColumnDefs = [];
...
function product_variant_detail(product_variant_id)
{
	$(document.body).css({'cursor' : 'wait'});
	$.ajax({
		type        : "POST",
		url         : "<?php echo base_url() ?>adminpanel/controller_product_variant/ajaxShowTblproduct_variantMasterData",
		data        : "product_variant_id="+product_variant_id,
		success: function(results) {
			$(document.body).css({'cursor' : 'default'});
			$('#recordDetailsPopUp').modal('show');
			$('#detailsPopUpData').html(results);
			$('#detailsPopUpTitle').html('Product Variants Details');
		},
		error: function() {
			$(document.body).css({'cursor' : 'default'});
...
//- export csv file of product_variant list - START
...
//- export csv file of product_variant list - END
