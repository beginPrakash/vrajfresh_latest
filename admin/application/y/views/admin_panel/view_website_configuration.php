				...
				<div class="box-info">
					<div class="box-text box-body profile">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<div class="col-md-4"><?php echo $Arr['configuration_type']; ?>: <span class="red">*</span></div>
								<div class="col-sm-8">
								<?php if($Arr['field_type']=='text') { ?>
								<input type="text" placeholder="<?php echo $Arr['configuration_key']; ?>" class="form-control" name="ArrData[<?php echo $Arr['configuration_id']; ?>]" value="<?php echo $Arr['configuration_value']; ?>" required />
								<?php } elseif($Arr['field_type']=='textarea') { ?>
								<textarea placeholder="<?php echo $Arr['configuration_key']; ?>" rows="3" class="form-control" id="editor1" name="ArrData[<?php echo $Arr['configuration_id']; ?>]"><?php echo $Arr['configuration_value']; ?></textarea>
								<?php } ?>
						...
						<div class="col-md-12">
							<div class="form-group">
							<div class="col-md-4"><?php echo $data['special_product_name']; ?>:</div>
							<div class="col-sm-8">
						...
						<div class="box-body">
							...
							<div class="col-md-12">
							<div class="btn_alignmemt"><button class="btn btn-success " name="submit" value="change_password">Update Settings</button></div>
							</div>
