                    ...
                    <tbody>
                        <?php foreach ($ArrState as $data) { ?>
                            <tr>
                                ...
                                <td>
                                    <a data="<?php echo $data['state_id']; ?>" class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                                    <a data="<?php echo $data['state_id']; ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
