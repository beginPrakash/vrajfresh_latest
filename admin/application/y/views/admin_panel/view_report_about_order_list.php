<div class="row">
   <div class="col-xs-12">
      <div class="box">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                 <!-- <input type="submit" class="btn btn-warning" name="searchExport" id="searchExport" value="Export to CSV">-->
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_report_about_order/report_about_order_list_export" id="searchExportaction">
               </div>
            </div>
			</div>
         <div class="box-body">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_report_about_order/delete_multiple_report_about_order_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_report_about_order/view_report_about_order_ajax" id="view_action">
         </div>
      </div>
   </div>
