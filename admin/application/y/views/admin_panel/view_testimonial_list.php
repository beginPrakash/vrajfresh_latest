   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>testimonial" method="post">
                  <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_testimonial/testimonial_list_export" id="searchExportaction">
               </div>
            </div>
            <!-- Fillter area end-->
         </div>
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_testimonial/delete_multiple_testimonial_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_testimonial/view_testimonial_ajax" id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
   </div>
...
//- export csv file of testimonial - START
$("#searchExport").click(function(){
 ...
 //- export csv file of testimonial - END
