               ...
               <div class="box-text box-body">
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">                         
						   <input type="text" name="user_signup_date" id="user_signup_date" placeholder="Signed up From" style="width:150px;" class="custom_txtbox date_picker_bottom_left" autocomplete="off" />	
							-
							<input type="text" name="user_signup_date_to" id="user_signup_date_to" placeholder="Signed up To" style="width:150px;" class="custom_txtbox date_picker_bottom_left" autocomplete="off" />  
					...
					<div class="form-group">
					   ...
					   <div class="col-md-9">
						<input type="text" name="last_order_date" style="width:150px;" id="last_order_date" value="" placeholder="Last Order Date" class="form-control date_picker_bottom_left" autocomplete="off" />
					   </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-9">
					  	<select name="selProduct" id="selProduct" class="form-control multiple_product_select">
					...
					<div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-md-2 col-md-offset-3">
                              ...
                              <button type="submit" class="btn btn-default" name="submit" id="submit" onClick="return validation();" <?php echo 'name="save_user"';?> >Next</button>
