   ...
   <div class="col-sm-12">
      ...
      ?>
         <table border="1" width="100%">
            ...
            <th>Price (in $)</th>
            <th>Total (in $)</th>
         <?php $i=1;foreach($ArrOrderProduct as $arr) { ?>
            <tr>
            <th><?php echo $i++; ?></th>
            <th><?php echo $arr['product_name']; ?></th>
            <th><?php echo $arr['qty']; ?></th>
            <th><?php echo $arr['unit_price']; ?></th>
            <th><?php echo $arr['total_amount']; ?></th>
            </tr>
         <?php } ?>
         </table>
	  <?php } ?>
