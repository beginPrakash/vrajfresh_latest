               ...
               <div class="box-text box-body">
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Banner URL" class="form-control" name="banner_link" value="<?php echo (isset($edit_id) && $edit_id > 0)? $banner['banner_link']:''; ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <!-- selectpicker -->
                           <textarea placeholder="Description" rows="3" id="editor1" class="form-control" name="description"><?php echo (isset($edit_id) && $edit_id > 0)? $banner['description']:''; ?></textarea>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9"> 
                           <input type="text" placeholder="Display Order" class="form-control only_number" name="banner_srno" value="<?php echo (isset($edit_id) && $edit_id > 0)? $banner['banner_srno']:''; ?>" required>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           <img height="25px" width="25px" src='<?php echo base_url();?>uploads/banner/<?php echo $banner['banner_image'] ?>' border=0 >
                        </div>
                        <div class="col-md-6">
						...
						<?php }else{ ?>
						<label><input type="radio" name="banner_type" id="banner_type1" value="slider" checked>Slider</label>
						<label><input type="radio" name="banner_type" id="banner_type2" value="bottom" >Bottom</label>
						<label><input type="radio" name="banner_type" id="banner_type3" value="side_banner" >Side Banner</label>
						<?php }?>
						</div>
                     ...
                     <div class="form-group">
                        <div class="col-md-2 col-md-offset-3">
                              <input type="hidden" value="<?php echo (isset($edit_id) && $edit_id > 0)?$edit_id:''; ?>" name="banner_id">
