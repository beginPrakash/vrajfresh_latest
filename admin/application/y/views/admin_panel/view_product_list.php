<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_product/product_list_export" id="searchExportaction">
               </div>
            </div>
            <!-- Fillter area end-->
         </div>
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_product/delete_multiple_product_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_product/view_product_ajax" id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
   </div>
...
/* DATA TABLE JS */
var orderCol = [[ 1, "desc" ]];  
var cols = [{ "bSortable": false },{ "bSortable": true },{ "bSortable": true }, { "bSortable": true }, { "bSortable": true }, { "bSortable": false }, { "bSortable": true }];
var colDef = [0,7];
var aoColumnDefs = [];
