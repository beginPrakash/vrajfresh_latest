...

{
...

	{
		...
		$this->db->insert('tbl_appconfigurations', $data);
...

	{
		...
		$update = $this->db->update('tbl_appconfigurations', $arrData);
...

	{
		...
		// $this->db->update('tbl_appconfigurations', array('is_deleted'=>1));

		$this->db->delete('tbl_appconfigurations');
