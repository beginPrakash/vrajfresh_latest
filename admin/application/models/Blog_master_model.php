...

{
	...
	public function getBlogDetailsUsingBlogUrl($blog_slug, $blog_id)

	{

		$query = $this->db->query("SELECT blog_id FROM `tblblog_master` WHERE blog_id != '" . $blog_id . "' and `blog_slug`='" . $blog_slug . "'");
	...
	public function isUrlExist($blog_slug, $blog_id)
