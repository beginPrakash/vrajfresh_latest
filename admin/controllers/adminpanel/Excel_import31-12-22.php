		...
		if(isset($_FILES["file"]["name"]))
		{
			...
			foreach($object->getWorksheetIterator() as $worksheet)
			{
				...
				for($row=2; $row<=$highestRow; $row++)
				{
					...
					{						/*echo $old_product_name.":".$product_name;echo "in variant<br>product_sku:".$product_sku;;exit;*/
					    ...
					    if(trim($old_product_name) != trim($product_name))
					    {
							if($product_variant_count==0)
							{
								...
								$variant_id = $this->product_model->add_variants($product_variant_data);								$variant_product_insert_count++;
							}
							else {echo "in else if";
			...
			echo '<br><b>Total Successfully Product Imported:</b>'.$product_insert_count;			echo '<br><b>Total Successfully Variant Product Imported:</b>'.$variant_product_insert_count;
