...
class Excel_import extends CI_Controller
{
	...
	function import()
	{
		if(isset($_FILES["file"]["name"]))
		{
			...
			$product_insert_count = 0;			$variant_product_insert_count = 0;
					...
					if($product_id > 0)
					{
						...
						if($category!='')
						{
							...
							if(is_array($ArrCategory) && count($ArrCategory)>0)
							{
								...
								{
									$ArrProductCategory = array('product_id'=>$product_id,'category_id'=>$category_id,'created_datetime' => date('Y-m-d H:i:s'),
									'created_by' => 1);
						...
						if($tags!='')
						{
							...
							if(is_array($ArrTags) && count($ArrTags)>0)
							{
								...
								{
									$ArrProductTag = array('product_id'=>$product_id,'tag_id'=>$tag,'created_datetime' => date('Y-m-d H:i:s'),
									'created_by' => 1);
