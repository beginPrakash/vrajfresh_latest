			...
			if ($this->form_validation->run())
			{
				...
				if($promotional_code_id > 0){ //update process
					...
					if($update > 0){
						...
						if(isset($_POST['product_selected_product']) && isset($_POST['product_discount_value']) && isset($_POST['product_discount_type']))
						{
							$ArrSelectedProduct = $_POST['product_selected_product'];
							$Arrdiscount_value = $_POST['product_discount_value'];
							$Arrdiscount_type = $_POST['product_discount_type'];
						}
