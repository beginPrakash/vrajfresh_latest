...
class order_model extends CI_Model
{
	...
	public function getOrderListData($Arr,$login_duser_id)
	{

		$column_order = array(null, 'tbl_orders.order_id', 'tbl_orders.order_datetime','tbl_orders.shipping_city','tbl_orders.shipping_zipcode', 'tbl_users.display_name', 'tbl_users.mobile_no', 'tbl_orders.order_total_amount', 'tbl_orders.order_status', 'tbl_orders.is_active', 'tbl_orders.created_datetime');

		$aColumns = array('tbl_orders.order_id', 'tbl_orders.order_datetime','tbl_orders.shipping_city','tbl_orders.shipping_zipcode','tbl_orders.delivery_datetime', 'tbl_users.display_name', 'tbl_users.mobile_no', 'tbl_orders.order_total_amount', 'tbl_orders.order_status', 'tbl_orders.is_active', 'tbl_orders.created_datetime');
		...
		if (@$_REQUEST['columns'] != "") {
			...
			$this->db->where('tbl_orders.is_deleted', 0);
			$this->db->where('tbl_orders.delivery_user_id', $login_duser_id);
			$this->db->join('tbl_users', 'tbl_users.user_id = tbl_orders.user_id', 'left');
