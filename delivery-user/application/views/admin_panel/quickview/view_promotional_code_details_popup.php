...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php echo $ArrFieldData['description'] ?>
      </label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php if (isset($ArrFieldData['start_from'])) {
            echo date('d-m-Y', strtotime($ArrFieldData['start_from']));
         } ?>
      </label>
   </div>
</div>
<div class="row">
   ...
   <div class="col-sm-9">
      <label style="font-weight:400; line-height: 20px;">
         <?php if (isset($ArrFieldData['valid_upto'])) {
            echo date('d-m-Y', strtotime($ArrFieldData['valid_upto']));
         } ?>
      </label>
   </div>
</div>
