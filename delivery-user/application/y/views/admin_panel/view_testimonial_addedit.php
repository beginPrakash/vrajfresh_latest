               ...
               <div class="box-text box-body">
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Sub Title" class="form-control" name="customer_subname" value="<?php echo (isset($edit_id) && $edit_id > 0)? $testimonial['customer_subname']:''; ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <!-- selectpicker -->
                           <textarea placeholder="Description" rows="3" id="editor1" class="form-control" name="description"><?php echo (isset($edit_id) && $edit_id > 0)? $testimonial['description']:''; ?></textarea>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9"> 
                           <input type="text" placeholder="Display Order" class="form-control only_number" name="display_order" value="<?php echo (isset($edit_id) && $edit_id > 0)? $testimonial['display_order']:''; ?>" required>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           <img height="25px" width="25px" src='<?php echo base_url();?>uploads/testimonial/<?php echo $testimonial['testimonial_image'] ?>' border=0 >
                        </div>
                        <div class="col-md-6">
						<input type="file" class="form-control" name="testimonial_image">
                        </div>
                           <input type="hidden" value="<?php echo $testimonial['testimonial_image'] ?>" name="cat_image">
                        <?php }else{ ?>
                           <input type="file" class="form-control" name="testimonial_image">      
                        <?php } ?>
                  ...
                  <?php }?>
                     ...
                     <div class="form-group">
                        <div class="col-md-2 col-md-offset-3">
                              <input type="hidden" value="<?php echo (isset($edit_id) && $edit_id > 0)?$edit_id:''; ?>" name="testimonial_id">
