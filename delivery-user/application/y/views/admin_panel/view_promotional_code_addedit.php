                  ...
                  <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                           ...
                           <input type="text" placeholder="Promotional Code" class="form-control allow_only_char_number" name="promotional_code" id="promotional_code" value="<?php 
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Description" class="form-control" name="description" value="<?php echo (isset($ArrFieldData['description']))?trim($ArrFieldData['description']):''; ?>">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Start From" name="start_from" id="start_from" value="<?php echo (isset($ArrFieldData['start_from']))?date('d-m-Y',strtotime($ArrFieldData['start_from'])):''; ?>" class='date_picker_bottom_left form-control' autocomplete="true">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Valid Upto" name="valid_upto" id="valid_upto" value="<?php echo (isset($ArrFieldData['valid_upto']))?date('d-m-Y',strtotime($ArrFieldData['valid_upto'])):''; ?>" class='date_picker_bottom_left form-control' autocomplete="true" >
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Minimum Order Value" name="minimum_order_value" id="minimum_order_value" value="<?php echo (isset($ArrFieldData['minimum_order_value']))?trim($ArrFieldData['minimum_order_value']):''; ?>" class='form-control' >
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" placeholder="Maximum Discount ($)" name="maximum_order_discount" id="maximum_order_discount" value="<?php echo (isset($ArrFieldData['maximum_order_discount']))?trim($ArrFieldData['maximum_order_discount']):''; ?>" class='form-control' >
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
						   <select name="promotional_type" class="form-control select_nocler" required>
							...
							<option value="S" <?php if(isset($ArrFieldData['promotional_type']) && $ArrFieldData['promotional_type']=='S') { echo 'selected'; } ?>>Single</option>
							<option value="M" <?php if(isset($ArrFieldData['promotional_type']) && $ArrFieldData['promotional_type']=='M') { echo 'selected'; } ?>>Multiple</option>
							<option value="OT" <?php if(isset($ArrFieldData['promotional_type']) && $ArrFieldData['promotional_type']=='OT') { echo 'selected'; } ?>>Only One Time</option>
						   </select>
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select name="apply_to" class="form-control select_nocler" required="" onchange="showHideClientGroupDiv(this.value);">
							<option value="">Select</option>
					...
					<!--
					 ...
					 <div class="form-group" id="customer_div" <?php if(@$ArrFieldData['apply_to']!='SC') { echo 'style="display:none;"'; } ?>>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                           ...
                           <input type="text" placeholder="Select Customer" id="search-box" class="form-control" name="specific_customer_email" value="<?php echo (isset($result_data['email']))?trim($result_data['email']):''; ?>" autocomplete="off" <?php if(isset($ArrFieldData) && $ArrFieldData['apply_to']!='SC') { echo 'required'; } ?>>
					...
					<div id="client_group_div" <?php if(@$ArrFieldData['apply_to']!='SG') { echo 'style="display:none;"'; } ?> >
					...
					<div class="col-md-3">
					 ...
					 <div class="col-md-9">
						...
						<?php if(isset($ArrClientGroup) && $ArrClientGroup > 0){
						...
						<?php foreach($ArrClientGroup as $group) { 
						if(!in_array($group['clientgroup_id'],$ArrSelectedClientGroupId))
							continue;
						?>
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select name="apply_to_product" class="form-control select_nocler" required="" onchange="showHideProductsDiv(this.value);">
							<option value="">Select</option>
							<option value="A" <?php echo (@$ArrFieldData['apply_to_product']=="A")?'Selected':'' ?>>All Products</option>
							<option value="SP" <?php echo (@$ArrFieldData['apply_to_product']=="SP")?'Selected':'' ?>>Specific Products</option>
							</select>
					...
					<div id="all_product_div">
						...
						<div class="col-md-9">
							<select name="discount_type" id="discount_type" class="form-control select_nocler" onChange="setDiscountType(this.value);">
							<option value="">Select</option>
							<option value="%" <?php echo (@$ArrFieldData['discount_type']=="%")?'Selected':''; ?>>Percentage</option>
							<option value="$" <?php echo (@$ArrFieldData['discount_type']=="$")?'Selected':''; ?>>Amount($)</option>
							</select>
						</div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-9">
							<input type="text" name="discount_value" id="discount_value" maxlength="4" value="<?php echo (isset($ArrFieldData['discount_value']))?trim($ArrFieldData['discount_value']):''; ?>" placeholder="Discount value" class="form-control only_number" /><span id="discount_type_span" style="float:right;font-size:22px;margin:-35px 6px;"><b><?php echo (isset($ArrFieldData['discount_value']))?trim($ArrFieldData['discount_value']):''; ?></b></span> 
						  </div>
						</div>
					</div>
					
					
					<div id="specific_product_div" <?php if(@$ArrFieldData['apply_to_product']=='SP') { echo 'style="display:block;"'; }else{ echo 'style="display:none;"'; } ?>>
					<div class="form-group">
					...
					<script>
						...
						<table id="promotional_code_products">
							...
							<tr>
								...
								<td>
									<select name="product_selected_product[]" required class="form-control selProduct<?php echo $product_counter; ?>" onChange="checkPreselected(this);">
										<option value="">--Select Product--</option>
										<?php foreach($ArrProducts as $product) { ?>
										<option value="<?php echo $product['product_id']; ?>" <?php if($product['product_id']==$product_details['product_id']) { echo 'selected'; } ?>><?php echo $product['product_name']; ?></option>
										<?php } ?>
									</select>
								</td>
								<td><a href="javascript:void(0);" onClick="addRow()" title="Click here to add new Product"><img src="<?php echo admin_media(); ?>dist/img/plus.png"></a></td>
							</tr>	
							...
							<tr>
								...
								<td>
									<select name="product_selected_product[]" class="form-control selProduct1" onChange="checkPreselected(this);">
										<option value="">--Select Product--</option>
										<?php foreach($ArrProducts as $product) { ?>
						...
						<input type="hidden" name="product_counter" id="product_counter" value="<?php echo $product_counter; ?>" />
						</div>
						</div>
					</div>
					...
					<div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-md-2 col-md-offset-3">
                              ...
                              <button type="submit" class="btn btn-default" name="submit" id="submit" onClick="return validation();" value="<?php echo (isset($edit_id) && $edit_id > 0)?'Update':'Add'; ?>" <?php echo 'name="save_user"';?> ><?php echo (isset($edit_id) && $edit_id > 0)?'Update':'Add'; ?></button>
