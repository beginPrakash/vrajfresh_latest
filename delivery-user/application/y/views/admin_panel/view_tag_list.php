   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>tag" method="post">
                  <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_tag/tag_list_export" id="searchExportaction">
               </div>
            </div>
            <!-- Fillter area end-->
         </div>
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_tag/delete_multiple_tag_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_tag/view_tag_ajax" id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
   </div>
...
/* DATA TABLE JS */
var orderCol = [[ 1, "desc" ]];  
var cols = [{ "bSortable": false },{ "bSortable": true },{ "bSortable": true }, { "bSortable": false }];
var colDef = [0,4];
var aoColumnDefs = [];
