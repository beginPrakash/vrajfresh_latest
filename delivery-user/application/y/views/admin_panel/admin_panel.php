   ...
   <body class="<?php echo $side_bar_menu_class; ?>">
      <div class="wrapper">
         ...
         <header class="main-header">
            <a href="#" class="logo"><span class="logo-lg"><b><?php echo $temp_site_name; ?></b></span></a>
            <!-- Header Navbar -->
            <nav class="navbar navbar-static-top" role="navigation">
				   <a href="#" class="sidebar-toggle left_togle_btn_arrow" data-toggle="offcanvas" role="button" onClick="SaveSideBarClickEvent();">
				      <span class="sr-only">Toggle navigation</span>
				   </a>  
			      <?php if(isset($cms_title)) { ?>
                   <i class="fa fa-angle-double-right bredcome_icon" aria-hidden="true"></i>
               <div class="cms_title responsive_ttl_s" style="color: #fff;font-size: 16px;display: inline-block;margin: 13px 0 0 0;">
                  <?php echo $cms_title; ?>
               </div>
               <?php } ?>
               <!-- Navbar Right Menu -->
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="user-footer">
                              ...
                              <div class="pull-right">
                                 <a href="<?php echo SITE_URL; ?>update-password" class="btn btn-default btn-flat">Change Password</a>
                              </div>
                           </li>
                        </ul>
                     </li>
         ...
         <footer class="main-footer">
			...
			<span class="mobile_all_fill"><strong>Copyright &copy; <a target="_blank" href="#">VrajFresh</a>.</strong> All rights reserved.</span>
