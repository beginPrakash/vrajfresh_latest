                  ...
                  <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          ...
                          <input type="radio" name="group" id="radio11" value="1" checked="checked" onClick="titleHideShow(1);">
						  <label for="radio11">Customer add in existing group</label>
						  </div>
						  <div class="radio_left_status">
						  <input type="radio" name="group" id="radio22" value="0" onClick="titleHideShow(0);">
					...
					<div class="form-group" id="client_group_title" style="display:none;">
					  <div class="col-md-3"><label>Customer Group Title<span class="red">*</span>: </label></div>
					  <div class="col-md-9"><input type="text" placeholder="Group Title" class="form-control" id="clientgroup_title" name="clientgroup_title">
					  <?php echo form_error('clientgroup_title'); ?></div>
					</div>
					<div class="form-group">
						<div class="col-md-3">
                     ...
                     <div class="form-group">
                        <div class="col-md-2 col-md-offset-3">
                              <input type="hidden" value="<?php echo (isset($edit_id) && $edit_id > 0)?$edit_id:''; ?>" name="clientgroup_id">
                              <button type="submit" class="btn btn-default" name="submit" id="submit" onClick="" value="<?php echo (isset($edit_id) && $edit_id > 0)?'Update':'Add'; ?>" <?php echo 'name="save_user"';?> ><?php echo (isset($edit_id) && $edit_id > 0)?'Update':'Add'; ?></button>
