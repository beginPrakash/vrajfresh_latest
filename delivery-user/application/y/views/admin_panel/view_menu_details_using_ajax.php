...
<div class="row">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['menu_name'] ?></label>
   </div>
</div>
<div class="row">
   <div class="col-sm-3">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;">
		...
		?>
		<a href="<?php echo $value['menu_link']; ?>" target="_blank"><?php echo $value['menu_title']; ?></a><br/>
		<?php
		} 
		}//End if 
		?>
