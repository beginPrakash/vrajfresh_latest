<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>clientgroup" method="post">
                  <div class="col-sm-2">
                     <input type="text" name="ser_from_date" id="ser_from_date" value="" class="form-control date_picker_bottom_left" placeholder="From Date" autocomplete="off" />
                  </div>
                  <div class="col-sm-2">
                     <input type="text" name="ser_to_date" id="ser_to_date" value="" class="form-control date_picker_bottom_left" placeholder="To Date" autocomplete="off" />
                  </div>
                  <div class="col-sm-2">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_clientgroup/delete_multiple_clientgroup_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_clientgroup/view_clientgroup_ajax" id="view_action">
      </div>
   </div>
</div>
