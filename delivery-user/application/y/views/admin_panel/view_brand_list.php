<div class="row">
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            ...
            <div class="row">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_brand/brand_list_export" id="searchExportaction">
               </div>
            </div>
            <!-- Fillter area end-->
         </div>
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_brand/delete_multiple_brand_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/Controller_brand/view_brand_ajax" id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
   </div>
