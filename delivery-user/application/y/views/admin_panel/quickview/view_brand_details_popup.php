...
<div class="row">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['brand_name'] ?></label>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['brand_description'] ?></label>
   </div>
</div>
