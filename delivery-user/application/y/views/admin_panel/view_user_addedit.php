<div class="row">
   <div class="col-md-12">
      ...
      <div class="box box-primary">
         ...
         <!-- form start -->
         <form role="form" method="post" name="user" id="user" action="<?php echo SITE_URL ?>adminpanel/controller_user/save">
            <div class="box-body">
               <!-- FORM FIELD -->
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['last_name'] ?>" placeholder="Last Name" class="form-control" name="last_name" required>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" placeholder="user_name" class="form-control" id="user_exist" name="user_name" value="<?php echo @$ArrFieldData['user_name'] ?>" required>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="password" placeholder="password" class="form-control" value="<?php echo @$ArrFieldData['password'] ?>" name="password" required >
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" placeholder="email" class="form-control" name="email" id="email" value="<?php echo @$ArrFieldData['email'] ?>" required>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Joining Date : </label>
                        <input type="text" value="<?php echo (isset($ArrFieldData['created_datetime']))?date('Y-m-d',strtotime($ArrFieldData['created_datetime'])):''; ?>" placeholder="joining date" name="joining_date" id="joining_date" class='date_picker_bottom_left form-control' autocomplete="false"> 
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['address'] ?>" placeholder="Address 1" class="form-control" name="address1">
                     <?php echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Mobile : </label>
                     <input type="text" value="<?php echo @$ArrFieldData['mobile_no'] ?>" placeholder="Mobile" class="form-control numberonly" name="mobile_no" maxlength="12">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($ArrFieldData['birth_date']))?date('Y-m-d',strtotime($ArrFieldData['birth_date'])):''; ?>" placeholder="Birth Date" name="birth_date" id="birth_date" class='date_picker_bottom_left form-control' autocomplete="false">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($ArrFieldData['anniversary_date']))?date('Y-m-d',strtotime($ArrFieldData['anniversary_date'])):''; ?>" placeholder="Anniversary" class="date_picker_top_left form-control" name="anniversary" id="anniversary"  autocomplete="false">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['qualification'] ?>" placeholder="Qualification" class="form-control" name="qualification">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo @$ArrFieldData['experience'] ?>" placeholder="experience" class="form-control" name="experience">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
                  <div class="form-group">
                     <label>Skills:</label>
                     <input type="text" value="<?php echo @$ArrFieldData['skills'] ?>" placeholder="Skills" class="form-control" name="skills">
                     <?php //echo form_error('name'); ?>
                  </div>
               </div>
               <div class="col-sm-4">
      ...
      <input type="hidden" id="check_user" value="<?php echo SITE_URL ?>adminpanel/controller_user/ajaxCheckUsername">
