                          ...
                          <?php
                           foreach($ArrProductMasterVariants as $ArrPV)
						   {
							...
							foreach($ArrPVValue as $variant_value)
							{
								...
								?>
								&nbsp;&nbsp;<input type="checkbox" name="<?php echo $vname; ?>[]" value="<?php echo $variant_value; ?>" <?php if($temp_checked) { echo 'checked'; }?>>
                     ...
                     <div class="col-sm-3">
                        <div class="radio_btn_design_add_products">
                           ...
                           <?php if ( !empty($edit_id) ){ ?>
                              <label style="padding-left: 0px;"> <input type="radio" name="is_featured" value="1" <?php if (!empty($edit_id) && $product['is_home_display']  =="1") {  echo "checked"; } ?>> Yes  
                              <input type="radio" name="is_featured" value="0" <?php if ( !empty($edit_id) && $product['is_home_display']  =="0") {  echo "checked"; } ?>> No </label>
                              <?php } else{ ?>
                        ...
                        <div class="radio_btn_design_add_products">
                           ...
                           <?php if ( !empty($edit_id) ){ ?>
                              <label style="padding-left: 0px; width: 100%;"> 
                                <input type="radio" name="is_sale" value="1" <?php if ($product['product_type']  =="1") {  echo "checked"; } ?>> Yes  
                                <input type="radio" name="is_sale" value="0" <?php if ($product['product_type']  =="0") {  echo "checked"; } ?>> No 
                              </label>
                              <?php } else{ ?>
                        ...
                        <div class="radio_btn_design_add_products">
                           ...
                           <div class="checkbox">
                              <?php if ( !empty($edit_id) ){ ?>
                                ...
                                <input type="radio" name="product_style" value="1" <?php if ($product['product_style']  =="1") {  echo "checked"; } ?>> Yes  
                                <input type="radio" name="product_style" value="0" <?php if ($product['product_style']  =="0") {  echo "checked"; } ?>> No </label>
                                <?php } else{ ?>
                                  <label style="padding-left: 0px;"> 
                     ...
                     <div class="col-sm-3">
                        <div class="radio_btn_design_add_products">
                           ...
                           <div class="checkbox">
                              <?php if ( !empty($edit_id) ){ ?>
                                <label style="width: 100%; padding-left: 0px;"> 
                                <input type="radio" name="is_active" value="1" <?php if ($product['is_active']  =="1") {  echo "checked"; } ?>> Yes  
                                <input type="radio" name="is_active" value="0" <?php if ($product['is_active']  =="0") {  echo "checked"; } ?>> No </label>
                                <?php } else{ ?>
                                  <label style="padding-left: 0px;"> 
