   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>contact-inquiry" method="post">
                  <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                 <!-- <input type="submit" class="btn btn-warning" name="searchExport" id="searchExport" value="Export to CSV">-->
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_contact_inquiry/contact_inquiry_list_export" id="searchExportaction">
               </div>
            </div>
			</div>
         <div class="box-body">
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_contact_inquiry/delete_multiple_contact_inquiry_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_contact_inquiry/view_contact_inquiry_ajax" id="view_action">
         </div>
      </div>
   </div>
