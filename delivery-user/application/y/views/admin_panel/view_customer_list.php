   ...
   <div class="col-xs-12">
      <div class="box">
         <div class="box-header filter_div">
            <!-- Fillter area -->
            <div class="row">
               <form id="frmListDataFilter" action="<?php echo SITE_URL ?>customers" method="post">
                  <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="hidden" value="<?php echo SITE_URL ?>adminpanel/controller_customer/customer_list_export" id="searchExportaction">
               </div>
            </div>
            <!-- Fillter area end-->
         </div>
         ...
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_customer/delete_multiple_customer_record" id="multiple_delete_action">
         <input type="hidden" value="<?php echo base_url() ?>adminpanel/controller_customer/view_customer_ajax" id="view_action">
         <!-- /.box-body -->
      </div>
      <!-- /.box -->
   </div>
...
/* DATA TABLE JS */
var orderCol = [[ 1, "desc" ]];  
var cols = [{ "bSortable": false },{ "bSortable": false }, { "bSortable": true }, { "bSortable": true }, { "bSortable": false }, { "bSortable": true }];
var colDef = [0,6];
var aoColumnDefs = [];
