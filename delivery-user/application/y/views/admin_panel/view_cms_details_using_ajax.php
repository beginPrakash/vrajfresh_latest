...
<div class="row">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['cms_title'] ?></label>
   </div>
</div>
<div class="row">
   <div class="col-sm-3">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['cms_url'] ?></label>
   </div>
</div>
<div class="row">
   <div class="col-sm-3">
   ...
   <div class="col-sm-9">
      <label  style="font-weight:400; line-height: 20px;"><?php echo $ArrFieldData['cms_description'] ?></label>
   </div>
</div>
<div class="row">
   <div class="col-sm-3">
