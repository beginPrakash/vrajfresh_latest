...
<script type="text/javascript" language="javascript" src="<?php echo ADMIN_PANEL_THEME_PATH; ?>dist/js/jscharts.js"></script>
...
<div class="row">
   ...
   <figure class="highcharts-figure">
    ...
    series: [{
        ...
        data: [7999, 5500, 560, 1500, 1200, 5800, 2000, 11000, 2300, 1800, 950, 350]
    }]
});
	</script>
   ...
   <figure class="highcharts-figure">
    ...
    series: [{
        ...
        data: [7, 6, 5, 15, 12, 5, 2, 11, 23, 18, 9, 3]
...
<div class="row"><div class="col-lg-12 col-xs-12"><hr></div></div>
<div class="row">
	<div class="col-lg-12 col-xs-12">
   ...
   <figure class="highcharts-figure">
    <div id="product_category_shares_sales"></div>
	</figure>
	<script>
   Highcharts.chart('product_category_shares_sales', {
    ...
    title: {
        text: 'Product Category Shares in Current Month'
    },
    tooltip: {
    ...
    series: [{
		...
		<div class="col-lg-6 col-xs-6">
			<figure class="highcharts-figure">
			<div id="monthly_new_repeat_customer"></div>
			</figure>
			<script>
